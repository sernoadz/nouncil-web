  ...
  return (
    ...
    <div className="border-noun-red border-t-[12px] bg-slate-200 text-slate-900">
      ...
      <div className="flex flex-col items-center container mx-auto">
        ...
        <div className="w-32 my-8 md:my-12">
          <Image src="/nouncil-logo.png" alt="Nouncil" width={408} height={432} layout="responsive" />
        </div>

        <a className="hover:bg-opacity-80 transition bg-noun-red text-white px-8 py-3 font-nouns text-xl rounded-xl mb-16" target="_blank" rel="noreferrer" href="https://docs.google.com/document/d/1wGOWfLYYiYK9PrAyH4Q-uAWsiwals818XFocYXAh1pY/edit">Apply for Membership</a>
